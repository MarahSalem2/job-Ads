        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">{{__('cms.edit_specialization')}}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
              <form id="create-form">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="description" value="{{$specialization->description}}" 
              ...
              <div class="card-footer">
                <button type="button" onclick="performUpdate('{{$specialization->id}}')" class="btn btn-primary">{{__('cms.save')}}</button>
              </div>
            </form>
          </div>
          <!-- /.card -->
...
<script>
  function performUpdate(){
    ...
    //multipart/form-data
      axios.put('/cms/admin/specializations/{{$specialization->id}}', {
      ...
      .then(function (response) {
        ...
        window.location.href = '/cms/admin/specializations';
      })
