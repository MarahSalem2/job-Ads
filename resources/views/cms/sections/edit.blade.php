        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">{{__('cms.edit_section')}}</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
              <form id="create-form">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="name" value="{{$section->name}}"
                  placeholder="{{__('cms.name')}}">
                </div>

                <div class="form-group">
                  <label for="description">{{__('cms.description')}}</label>
                  <input type="text" class="form-control" id="description" value="{{$section->description}}" 
...
<script>
  function performUpdate(){
    ...
    //multipart/form-data
      axios.put('/cms/admin/sections/{{$section->id}}', {
      ...
      .then(function (response) {
        ...
        window.location.href = '/cms/admin/sections';
      })
